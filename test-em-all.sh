...
--url 'https://dev-dm.jp.auth0.com/oauth/token' \
--header 'content-type: application/json' \
--data '{"grant_type":"password","username":"","password":"","audience":"https://localhost:8443/product-composite","scope":"openid email product:read product:write", "client_id":"", "client_secret":""}' -s \
| jq -r .access_token)
...
--url 'https://dev-dm.jp.auth0.com/oauth/token' \
--header 'content-type: application/json' \
--data '{"grant_type":"password","username":"","password":"","audience":"https://localhost:8443/product-composite","scope":"openid email product:read", "client_id":"", "client_secret":""}' \
 -s | jq -r .access_token)
